 ...
 */
const postMessage = <A extends UtilsEvents>(
  data: UtilsEventsPostMessageData<A>,
) => {
...
// eslint-disable-next-line no-restricted-globals
self.onmessage = async (event: MessageEvent<UtilsWorkerEventsData>) => {
