...
import type {
  ClientEvents,
  ClientEventsPostMessageData,
  ClientEventsErrorData,
  ClientWorkerEventsData,
} from "@/types";
 ...
 */
const postMessage = <A extends ClientEvents>(
  data: ClientEventsPostMessageData<A>,
) => {
...
// eslint-disable-next-line no-restricted-globals
self.onmessage = async (event: MessageEvent<ClientWorkerEventsData>) => {
